...
function Card() {
    return(
        ...
        <footer className="card-footer"><a target="_blank" rel="noopener noreferrer" href="https://dansup.github.io/bulma-templates/templates/cards.html" className="card-footer-item">Demo</a> <a target="_blank" rel="noopener noreferrer" href="https://github.com/dansup/bulma-templates/blob/master/templates/cards.html" className="card-footer-item">Download</a></footer>
